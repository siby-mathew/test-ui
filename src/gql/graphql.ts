...
export const GetUserMailboxDocument = {
  kind: "Document",
  definitions: [
    {
                ...
                { kind: "Field", name: { kind: "Name", value: "address" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "isEncrypted" },
                      },
                      {
                        kind: "Field",
...
} as unknown as DocumentNode<GetUserMailboxQuery, GetUserMailboxQueryVariables>;
